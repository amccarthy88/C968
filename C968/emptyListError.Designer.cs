namespace C968
{
    partial class emptyListError
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4.Font = new Font("the Gingerbread House", 16.2F, FontStyle.Regular, GraphicsUnit.Point);
            label4.ForeColor = SystemColors.ButtonHighlight;
            label4.Location = new Point(87, 122);
            label4.Name = "label4";
            label4.Size = new Size(150, 31);
            label4.TabIndex = 4;
            label4.Text = "You are all alone";
            ...
            label5.Location = new Point(229, 119);
            label5.Name = "label5";
